...
interface IAave {
    function supply(address asset, uint256 amount, address onBehalfOf, uint16 refrerralCode) external;

    function borrow(address asset, uint256 amout, uint256 interestRateMode, uint16 referralCode, address onBehalfOf) external;
}
